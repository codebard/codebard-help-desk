...
<div class="<?php echo $this->internal['prefix'];?>settings">
	...
	<div id="cb_p3_setup_wizard_header"><a href="https://codebard.com" target="_blank"><img src="<?php echo $this->internal['plugin_url']; ?>images/codebard_very_small.png"></a> <?php echo $this->lang['help_desk_label'];?> <?php echo $this->lang['plugin_is_almost_ready'];?></div>

	
	<div class="cb_p3_setup_wizard_big_heading">
	...
	<div class="cb_p3_setup_wizard_big_heading"><?php echo $this->lang['setup_now_you_can'];?></div>
	...
	<div class="cb_p3_setup_wizard_one_col" style="text-align : center;font-size : 100%; max-width : 600px;">
			...
			<button class="cb_p3_admin_button" onclick="window.open('<?php echo $this->internal['admin_url'].'admin.php?page=settings_'.$this->internal['id']; ?>');" target="_blank"><?php echo $this->lang['setup_change_settings'];?></button>
	...
	?>
	<hr width="100%" />
	<div class="cb_p3_setup_wizard_big_heading"><?php echo $this->lang['setup_wizard_done'];?></div>
	<div class="cb_p3_setup_wizard_small_heading"><?php echo $this->lang['setup_wizard_if_you_have_questions'];?></div>
